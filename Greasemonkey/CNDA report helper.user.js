...
if ( comment_container.length ) {
	var update_battle_field_button = '<br><button class="std_global_btn tinySize" type="button" onclick="loadBattleFieldData()" title="Load from battle field">Load</button>';
